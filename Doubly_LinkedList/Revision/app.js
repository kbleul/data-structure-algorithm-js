...
const DLinkedList = require("./DLinkedList")
  ...
  let dlisttwo = new DLinkedList();

  dlisttwo.insertAtHead(10)
  dlisttwo.removeAtHead()

  console.log(dlisttwo)
    dlisttwo.print()
  ...
  let dlist = DLinkedList.fromArray(10,20,30,40,50)

      dlist.print()

  dlist.insertAtTail(99)
  dlist.insertAtTail(100)
  dlist.insertAtTail(101)
  dlist.insertAtTail(102)



      dlist.insertAtIndex(2,55)
